  ...
  return (
    <section id='services' className='w-full bg-slate-200 flex flex-col lg:flex-row gap-10 lg:gap-20 h-fit px-7 py-4 lg:px-16 lg:py-12'>
      <div className='flex justify-center items-start flex-col gap-8 lg:w-1/2'>
        ...
        <p className='text-black-300 text-2xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veritatis, inventore. Nemo rem eligendi ullam doloremque sed beatae! Ducimus, unde cum?</p>
        <div className='flex justify-center items-center gap-7'>
          <button className='bg-green-800 text-white px-8 py-3 rounded-md text-[18px] hover:bg-black hover:text-white hover:cursor-pointer'>Read More</button>
        </div>
      </div>
